...
<div id='content'>
    <ul class='filtertab'>
        ...
        <li class='active'>服务器启动/停止</li>
        <a href='s7_events_client.jsp'><li>客户端会话</li></a>
        <a href='s7_events_info.jsp'><li>读取信息</li></a>
        <a href='s7_events_deep.jsp'><li>深入访问</li></a>
    </ul>
    <%
        (new S7EventReader(session, request, "s7_events_server.jsp", S7EventReader.FILTER_SERVER_START_STOP)).printContent(out);
    %>
</div>
</body>
</html>