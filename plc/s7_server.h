...
protected:
    ...
    void DoReadEvent(int Sender, longword Code, word RetCode, word Param1, word Param2, word Param3, word Param4);
    word ForcePDU;
public:
    TPlcMemory *FDevice;
    int WorkInterval;
    byte CpuStatus;
    TSnap7Server(TPlcMemory *Device);
    ~TSnap7Server();
