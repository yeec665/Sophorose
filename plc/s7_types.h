...
const longword evcModbusPDUincoming   = 0x20000000;
const longword evcModbusData          = 0x40000000;
const longword evcModbusDiagnostics   = 0x80000000;
// Event SubCodes
...
const word evrMemoryLimit             = 0x0012;
const word evrIllegalProtocolId       = 0x0013;
const word evrShortPDU                = 0x0014;
const word evrWrongSizeData           = 0x0015;
const word evrUnknownFunctionCode     = 0x0016;
const word evrUnknownSubFunctionCode  = 0x0017;
